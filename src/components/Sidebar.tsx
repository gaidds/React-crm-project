    ...
    switch (text) {
      case 'contacts':
        return screen === 'contacts' ? (
          <FaAddressBook fill="#7B61FF" size={22} />
        ) : (
          <FaAddressBook size={22} />
        );
      case 'deals':
        return screen === 'deals' ? (
          <FaHandshake fill="#7B61FF" size={22} />
        ) : (
          <FaHandshake size={22} />
        );
      case 'accounts':
        return screen === 'accounts' ? (
          <FaBuilding fill="#7B61FF" size={22} />
        ) : (
          <FaBuilding size={22} />
        );
      case 'companies':
        return screen === 'companies' ? (
          <FaIndustry fill="#7B61FF" size={22} />
        ) : (
          <FaIndustry size={22} />
        );
      // case 'analytics':
      ...
      case 'users':
        return screen === 'users' ? (
          <FaUserFriends fill="#7B61FF" size={22} />
        ) : (
          <FaUserFriends size={22} />
        );
      case 'cases':
        return screen === 'cases' ? (
          <FaBriefcase fill="#7B61FF" size={22} />
        ) : (
          <FaBriefcase size={22} />
        );
      default:
        return <FaDiceD6 fill="#7B61FF" />;
    }
  };
    ...
    switch (text) {
      case 'logout':
        return screen === 'logout' ? (
          <FaSignOutAlt fill="#7B61FF" size={22} />
        ) : (
      ...
      case 'dashboard':
        return screen === 'dashboard' ? (
          <FaSlidersH fill="#7B61FF" size={22} />
        ) : (
          <FaSlidersH size={22} />
        );
      case 'settings':
        return screen === 'settings' ? (
          <FaCog fill="#7B61FF" size={22} />
        ) : (
          <FaCog size={22} />
        );
    }
      ...
      <Box>
          ...
          <Box>
            <Toolbar>
              <div
                ...
                onClick={() => setDrawerWidth(drawerWidth === 70 ? 200 : 70)}
              >
                <img
                  src={logo}
                  width={'35px'}
        ...
        >
          <Routes>
            ...
            <Route path="/app/user-details/:id" element={<ProfilePage />} />
