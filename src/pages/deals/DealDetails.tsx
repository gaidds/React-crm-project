              ...
              <Grid container spacing={2}>
               {/* Deal name and website */}
                <Grid item xs={12} sm={6}>
                  ...
                  <Box sx={{ padding: '0px 0px 0px 100px', color: 'grey', marginTop: '20px' }}>
...
<Grid item xs={12} sm={6}>
  <Box
    sx={{
      ...
      alignItems: 'center',
      padding: '110px 60px 0 0', // Adjust padding to place it further down
      whiteSpace: 'nowrap',
      ...
      {new Date(deal.close_date).toLocaleDateString()}
            ...
            <Grid container spacing={2} padding={'0px 0px 80px 80px'}>
              ...
              {/* Deal Details like Account, Industry, etc. */}
                  <Grid item xs={12} sm={4} >
                    <Box sx={{ display: 'grid', gridTemplateColumns: '150px 1fr', rowGap: 2, columnGap: 2 }}>
                      ...
                      <p>{deal.assigned_to.map(user => user.user_details.email).join(', ')}</p>
